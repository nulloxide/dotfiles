...
**doggo** - Modern DNS client, readable output
**trippy** - Network diagnostic (traceroute + ping combined)
**iperf3** - Bandwidth measurement
**speedtest** - Ookla CLI (official)

## Productivity

**just** - Project-specific task runner (like make but sane)
**hyperfine** - CLI benchmarking with statistical analysis
**sd** - Intuitive find & replace (sed alternative)
**ouch** - Painless compression/decompression (any format)
**tlrc** - Simplified man pages with examples

## Editors

**VS Code** - Extensions ecosystem, remote dev, debugging
